  ...
  context "for user_agents option" do
    context "passed as a string" do
      ...
      it "raises an error" do
        expect { Mixlib::Install.new(product_name: "cinc", channel: :stable, user_agent_headers: user_agent_headers) }.to raise_error(Mixlib::Install::Options::InvalidOptions, /user_agent_headers must be an Array/)
      end
    end
    ...
    context "headers passed with spaces" do
      ...
      it "raises an error" do
        expect { Mixlib::Install.new(product_name: "cinc", channel: :stable, user_agent_headers: user_agent_headers) }.to raise_error(Mixlib::Install::Options::InvalidOptions, /user agent headers can not have spaces/)
      end
    end
  end
